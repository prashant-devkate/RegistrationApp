        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AadharFrontBlobName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    AadharBackBlobName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    PhotoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AadharFrontUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AadharBackUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "PaymentPending"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountInPaise = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false, defaultValue: "INR"),
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedAt", "Currency", "Description", "Name", "RegistrationFee" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "INR", "Batsman category", "Batsman", 500m },
                    { 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "INR", "Bowler category", "Bowler", 500m },
                    { 3, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "INR", "All Rounder category", "All Rounder", 500m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_RegistrationId_Status",
                table: "Payments",
                columns: new[] { "RegistrationId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registrations_PhoneNumber_Status",
                table: "Registrations",
